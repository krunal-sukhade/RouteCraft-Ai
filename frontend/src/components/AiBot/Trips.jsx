              ...
              <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="rounded-xl bg-gradient-to-r from-blue-500 to-purple-600 px-4 py-2 text-sm font-medium text-white transition hover:shadow-lg flex items-center gap-2"
                  >
              ...
              <aside className="min-h-0 overflow-y-auto rounded-3xl border border-blue-100/15 bg-slate-900/55 p-4 backdrop-blur-xl md:p-5">
                {!selectedTrip ? (
                  ...
                  <div className="grid gap-4">
                    ...
                    <button
                      onClick={handleStartPlanning}
                      className="w-full rounded-xl bg-gradient-to-r from-blue-500 to-purple-600 py-2 text-sm font-medium text-white transition hover:shadow-lg flex items-center justify-center gap-2"
                    >
                      Plan a Similar Trip <ArrowRight className="w-4 h-4" />
                    </button>
                  </div>
                )}
              </aside>
