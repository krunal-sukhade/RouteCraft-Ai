...
const suggestions = [
  ...
  },
  {
    ...
    image: "https://gcp-na-images.contentstack.com/v3/assets/bltea6093859af6183b/blt851ab3e4389b88a7/698a337bb21a9c02b5506342/Worlds-Greatest-Places-2022-BaliIndonesia.jpeg?branch=production",
    duration: "4 Days",
    durationType: "weekend",
    season: "winter",
    vibe: "adventure",
...
export default function AiSuggestions({ themeMode, onToggleTheme }) {
  ...
  return (
    <div className="min-h-screen bg-transparent pt-20 md:pt-24">
      ...
      <div className="mx-auto grid h-full max-w-375 gap-4 md:gap-5 lg:grid-cols-[220px_1fr]">
        <Sidebar themeMode={themeMode} onToggleTheme={onToggleTheme} />
                    ...
                    <div className="space-y-3 p-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        <button
                          ...
                          className="inline-flex items-center gap-1 rounded-lg bg-linear-to-r from-cyan-300 to-blue-400 px-2.5 py-1.5 text-xs font-semibold text-slate-900"
                        >
                ...
                <div className="grid gap-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <button
                      ...
                      className="inline-flex items-center justify-center gap-1 rounded-xl bg-linear-to-r from-cyan-300 to-blue-400 px-3 py-2 text-sm font-semibold text-slate-900"
                    >
